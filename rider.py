...
class Rider:
    ...
    def gen_drawing_vectors(self):
        sled = [
            # base structure
            LineShape([(0, 0), (94.4, 0)], width=6, lineColor="#aaa"),  # Top side of sledge
            LineShape([(-2, 38.2), (108.4, 38.2)], width=6, lineColor="#aaa"),  # Bottom side of sledge
            LineShape([(16.6, 3), (16.6, 35.2)], width=6, lineColor="#aaa"),  # Back vertical bar
            LineShape([(75, 3), (75, 35.2)], width=6, lineColor="#aaa"),  # Front vertical bar
            Arc([(108.4, 11.6)], theta=(26.7, -90, 260), width=6, lineColor="#aaa", fillColor=None)  # Bumper
        ]
        body = [
            Polygon([(54, -17.4), (54, 19), (60.6, 28.4), (86, 18.6), (80.8, -17.4)], smooth=True),  # face
            Circle([(68, 12)], fillColor="black", radius=3.2),  # eye
            Polygon([(0, -17.4), (56, -17.4), (56, 17.8), (0, 17.8)]),  # torso
            Arc([(80.8, 0)], theta=(20.2, -90, 180)),  # hat
            Circle([(106.8, 0)], fillColor="black", radius=5.8),  # pompon
            LineShape([(80.8, 21.2), (80.8, -21.2)], width=6),  # hat-face border
            Polygon([(56, -19.4), (56, -1.6), (80.8, -1.6), (80.8, -19.4)], fillColor="black"),  # Head rear
            LineShape([(49.2, -20), (49.2, -12)], lineColor="red", width=16, cap=tk.BUTT),  # Scarf on rider only,
            LineShape([(49.2, -12), (49.2, -4)], lineColor="white", width=16, cap=tk.BUTT),  # excludes flying part
            LineShape([(49.2, -4), (49.2, 4)], lineColor="red", width=16, cap=tk.BUTT),  # Scarf
            LineShape([(49.2, 4), (49.2, 12)], lineColor="white", width=16, cap=tk.BUTT),  # Scarf
            LineShape([(49.2, 12), (49.2, 20)], lineColor="red", width=16, cap=tk.BUTT)  # Scarf
        ]
        arm1 = [
