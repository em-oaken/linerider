...
class LineShape(Shape):
    def __init__(self, cors, fillColor=None, lineColor="black", width=1, smooth=False, cap=tk.ROUND):
    ...
    def render(self, pnt0, angle, app):
        ...
        for i in range(len(self.cors)):
            ...
            cor = app.player.adjust_pz(cor + pnt0)
...
class Polygon(Shape):
    def __init__(self, cors, fillColor="white", lineColor="black", width=1, smooth=False):
...
class Arc(Shape):  #also pieslice
    def __init__(self, cors, fillColor="white", lineColor="black", width=1, theta=(1, 0, 90)):
    ...
    def render(self, pnt0, angle, app):
        ...
        center = app.player.adjust_pz(center + pnt0)
...
class Circle(Shape):
    def __init__(self, cors, fillColor="white", lineColor="black", width=1, radius=1):
